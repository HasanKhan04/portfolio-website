                        ...
                        <tr>
                            <td className="left-side">
                                ...
                                <p>
                                    ...
                                    <br/>
                                    <br/>
                                    <a target = "_blank" rel = "noreferrer" href = "https://www.linkedin.com/in/hasan-khan04/">
                                        <FontAwesomeIcon icon={faLinkedin}  class = "icon" color = "#4d4d4e" />
                                    </a>
                                    <a target = "_blank" rel = "noreferrer" href = "mailto:h2khan@uwaterloo.ca">
                            ...
                            <td className="right-side">
                                <div >
                                    <form className="contact-form" onSubmit={sendEmail} ref={refForm}>
                                        <ul>
                                            <li className = "half">
